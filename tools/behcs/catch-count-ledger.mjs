...
export const CATCH_ROWS = Object.freeze([
  ...
  row({ id: 'C015', date: '2026-06-14', vantage: 'liris', source: 'docs/LIRIS-FRONTEND-PARITY-MATRIX-2026-06-14.hbp+docs/LIRIS-MODEL-SELECTOR-MATRIX-2026-06-14.hbp+docs/LIRIS-PROJECT-GUIDE-MATRIX-2026-06-14.hbp', file_or_test: 'tools/behcs/frontend-parity-matrix.mjs', defect_class: 'frontend-parity-gap', severity: 'MEDIUM', status: partial, owner: 'bilateral', fix_commit: 'frontend-parity+model-selector-M+project-guide-P', summary: 'frontend-parity-matrix-now-has-M-and-P-descriptor-artifacts-PARTIAL; T/C/Q/E/D/M/P partial still block green' }),
