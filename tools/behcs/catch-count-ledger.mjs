...
export const CATCH_ROWS = Object.freeze([
  ...
  row({ id: 'C015', date: '2026-06-13', vantage: 'acer-audit', source: 'docs/ACER-200STEP-ALIGNMENT-AUDIT-2026-06-13.hbp', file_or_test: 'docs/LIRIS-ODYSSEUS-CHATOS-FRONTEND-ABSORPTION-2026-06-12.hbp', defect_class: 'frontend-parity-gap', severity: 'MEDIUM', status: open, owner: 'bilateral', fix_commit: 'none-open', summary: 'unified-front-end-cutover-still-needs-model-tool-project-guide-parity-matrix' }),
  ...
  row({ id: 'C035', date: '2026-06-13', vantage: 'acer-native', source: 'docs/ACER-SLICE-ENGINE-LIVE-CRANK-RECEIPT-2026-06-13.hbp', file_or_test: 'canon/laws/LAW-SLICE-ENGINE.md', defect_class: 'class1-cosign-gate', severity: 'MEDIUM', status: open, owner: 'operator-pair', fix_commit: 'none-open-operator-gated', summary: 'LAW-SLICE-ENGINE-class1-cosign-mint-remains-operator-pair-physical-gated' }),
