...
export const CATCH_ROWS = Object.freeze([
  ...
  row({ id: 'C015', date: '2026-06-14', vantage: 'liris', source: 'docs/LIRIS-FRONTEND-PARITY-MATRIX-2026-06-14.hbp', file_or_test: 'tools/behcs/frontend-parity-matrix.mjs', defect_class: 'frontend-parity-gap', severity: 'MEDIUM', status: partial, owner: 'bilateral', fix_commit: 'this-frontend-parity-matrix-commit', summary: 'frontend-parity-matrix-now-exists-and-holds-cutover-red-M/P-partial-T/Q/E/D-still-block-green' }),
