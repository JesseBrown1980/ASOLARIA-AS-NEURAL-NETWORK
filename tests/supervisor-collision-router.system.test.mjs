...
const sealedFiles = [
  ...
  'docs/LIRIS-PROGRAM-CUBE-INGESTION-MAP-2026-06-14.hbp',
  'docs/LIRIS-AGENT-COST-LAYER-BOUNDARY-2026-06-14.hbp',
  'docs/LIRIS-TRIAD-HOST-ROUTER-GULP-PIPELINE-2026-06-14.hbp',
  'docs/LIRIS-PID-EMITTER-COST-ENVELOPE-2026-06-14.hbp',
  'docs/LIRIS-CELLPHONE-HOST-BRIDGE-BOUNDARY-2026-06-14.hbp',
  'docs/LIRIS-FROZEN-SLICE-CITY-SIGNAL-LIFECYCLE-2026-06-14.hbp',
  'docs/LIRIS-EIGHT-BYTE-HOST-PROCESS-UPGRADE-2026-06-14.hbp',
  'docs/LIRIS-ODYSSEUS-MTP-CONTROL-SURFACE-2026-06-14.hbp',
  'docs/LIRIS-ODYSSEUS-SCIENTIFIC-3D-FIELD-2026-06-14.hbp',
  'docs/ACER-CROSS-CHECK-ODYSSEUS-SCI3D-939cdac-2026-06-14.hbp',
  ...
  'docs/LIRIS-FRONTEND-PARITY-MATRIX-2026-06-14.hbp',
  'docs/ACER-ATTACK-LIRIS-FRONTEND-PARITY-MATRIX-2026-06-14.hbp',
  'docs/LIRIS-MODEL-SELECTOR-MATRIX-2026-06-14.hbp',
  'docs/LIRIS-PROJECT-GUIDE-MATRIX-2026-06-14.hbp',
  'docs/LIRIS-TOOL-SKILL-REGISTRY-MATRIX-2026-06-14.hbp',
  'docs/ACER-ATTACK-LIRIS-FRONTEND-MP-MATRICES-2026-06-14.hbp',
  ...
  'tools/behcs/frontend-parity-matrix.mjs',
  'tools/behcs/model-selector-matrix.mjs',
  'tools/behcs/project-guide-matrix.mjs',
  'tools/behcs/tool-skill-registry-matrix.mjs',
  'tools/behcs/program-cube-ingestion-map.mjs',
  'tools/behcs/agent-cost-layer-boundary.mjs',
  'tools/behcs/triad-host-router-gulp-pipeline.mjs',
  'tools/behcs/pid-emitter-cost-envelope.mjs',
  'tools/behcs/cellphone-host-bridge-boundary.mjs',
  'tools/behcs/frozen-slice-city-signal-lifecycle.mjs',
  'tools/behcs/eight-byte-host-process-upgrade.mjs',
  'tools/behcs/odysseus-mtp-control-surface.mjs',
  'tools/behcs/odysseus-scientific-3d-field.mjs',
  ...
  'tests/frontend-parity-matrix.unit.test.mjs',
  'tests/model-selector-matrix.unit.test.mjs',
  'tests/project-guide-matrix.unit.test.mjs',
  'tests/tool-skill-registry-matrix.unit.test.mjs',
  'tests/program-cube-ingestion-map.unit.test.mjs',
  'tests/agent-cost-layer-boundary.unit.test.mjs',
  'tests/triad-host-router-gulp-pipeline.unit.test.mjs',
  'tests/pid-emitter-cost-envelope.unit.test.mjs',
  'tests/cellphone-host-bridge-boundary.unit.test.mjs',
  'tests/frozen-slice-city-signal-lifecycle.unit.test.mjs',
  'tests/eight-byte-host-process-upgrade.unit.test.mjs',
  'tests/odysseus-mtp-control-surface.unit.test.mjs',
  'tests/odysseus-scientific-3d-field.unit.test.mjs',
